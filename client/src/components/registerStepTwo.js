...
const registerStepTwo = ({userInfo, dob, handleDob, setUserInfo, handleForm, status}) => {
    return (
        <div className={style.registerStepTwo}>
            ...
            <InputBox title="CCCD/CMND *" name="Ssn" check={status[0]} userInfo={userInfo} handleForm={handleForm}/>
